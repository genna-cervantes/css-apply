      ...
      <section className="min-h-screen flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center w-[80%] lg:w-full lg:px-50 lg:py-20">
          ...
          >
            ...
            <div className="text-black text-xs lg:text-md font-Inter font-light">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="hidden lg:block bg-gray-300 text-gray-700 px-15 py-3 rounded-lg font-inter font-semibold text-sm hover:bg-gray-400 transition-colors"
              >
                Back
              </button>
              <button
