                  ...
                  <div className="flex">
                    ...
                    <div className="w-3/5 p-6">
                      {(() => {
                        ...
                        return role ? (
                          <>
                            <div className="text-xs font-inter text-[#7a7a7a] mb-1">
                              {" "}
                              Be an Executive Assistant of
                            </div>
                            <h4 className="text-xl font-inter font-bold text-black">
                              {role.title}
                            </h4>
                            {role.ebName && (
                              <p className="text-sm italic font-inter text-[#134687] mb-3">
                                {role.ebName}
                              </p>
                            )}
