...
export default function UserDashboard() {
  ...
  return (
    <section className="min-h-screen bg-[#F3F3FD]">
      <header className="flex items-center justify-between bg-white shadow-md shadow-black/40 px-4 py-3 sm:px-6">
        <Image
      ...
      <div className="flex flex-col justify-center items-center py-[100px]">
        <div className="flex flex-col justify-center items-center gap-16">
          ...
          {/* Mobile carousel */}
          <div className="relative w-full max-w-[340px] sm:max-w-md md:hidden">
            <button
              aria-label="Previous"
              onClick={() => setCurrentSlide((s) => (s === 0 ? 2 : s - 1))}
              className="absolute left-2 top-1/2 -translate-y-1/2 z-10 grid place-items-center h-9 w-9 rounded-full bg-white shadow-md border border-[#D1D1D1] text-[#6B7280] hover:bg-gray-50 active:scale-95"
            >
              {/* Left chevron */}
              <svg
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 z-10 grid place-items-center h-9 w-9 rounded-full bg-white shadow-md border border-[#D1D1D1] text-[#6B7280] hover:bg-gray-50 active:scale-95"
            >
              {/* Right chevron */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="min-w-full flex justify-center">
                  <div className="relative flex flex-col w-64 h-[440px] md:w-80 md:h-[480px] rounded-[28px] border-2 border-[#005FD9] bg-white shadow-[0_8px_13px_0_rgba(0,0,0,0.25)] items-center justify-center">
                    ...
                    <a
                      ...
                      className="whitespace-nowrap absolute bottom-6 md:bottom-9 left-1/2 -translate-x-1/2 bg-[#044FAF] font-inter text-xs md:text-sm text-white px-4 py-2 md:px-6 md:py-3 rounded-md hover:bg-[#0349A2] transition-all duration-150 active:scale-95"
                    >
                      Apply as Member
                    </a>
                  </div>
      ...
      <footer className="w-full mt-16 py-8 px-5 md:px-20 bg-[#044FAF] text-white flex flex-col md:flex-row gap-8 md:gap-24 items-start border-b-10 border-[#287FEB]">
        <div className="flex flex-col gap-1">
          ...
          <div className="font-inter text-[11px] sm:text-xs mb-2 mt-5">
